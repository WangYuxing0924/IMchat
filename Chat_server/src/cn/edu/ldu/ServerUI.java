...
public class ServerUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JButton btnNewButton = new JButton("在线用户管理");
        ...
        topPanelLayout.setVerticalGroup(
        	topPanelLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(topPanelLayout.createSequentialGroup()
        			.addGap(15)
        			.addGroup(topPanelLayout.createParallelGroup(Alignment.BASELINE)
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        try {
            ...
            //创建并启动UDP消息接收线程
            Thread recvThread=new ReceiveMessage(serverSocket,this,par);
            recvThread.start();
            //创建并启动文件接收线程
