...
public class LoginUI extends javax.swing.JDialog {
     ...
     * @param modal
     */
	public static HashMap<String,JFrame> clientUIMap = new HashMap<String,JFrame>();
	public static HashMap<String,Message> isSendFileAllow = new HashMap<String,Message>();
     ...
     * @param evt 登录按钮被点击事件
     */
    private void btnRegisterPerformed(java.awt.event.ActionEvent evt) {
    	  try {
    		  this.dispose();
    ...
    try {
        ...
        if (backMsg.getType().equalsIgnoreCase("M_SUCCESS")) { //登录成功
            ...
            //"0" 是公聊窗口
            for(String userString:backMsg.getUserArrayList()) {
            	
                listModel.add(listModel.getSize(), userString+"(离线)");
                 }
               client.userList.setModel(listModel);
            
            
            
            clientUIMap.put("0", client);
            Thread recvThread=new ReceiveMessage(clientSocket,clientUIMap);
