...
public class ReceiveMail extends Thread{
	...
	PrivateClientUI clientUI;
	private int baseHostPort;
	public int hostPort=0;
	public ReceiveMail(PrivateClientUI clientUI,int hostport){
   ...
   public void run() {
	   try {
           ...
           while (true) { //处理所有客户机连接
               ...
               SwingWorker<Integer,Object> recver=new RecvFile(fileSocket,clientUI,tks,ks); //创建客户线程
