...
//        recvThread.start();//启动消息线程    
    ...
    private void initComponents() {
        ...
        leftScrollPane2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "发言窗口", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("宋体", 1, 14)));
       ...
       /*修改过*/   /* userList.addMouseListener(new java.awt.event.MouseAdapter(){
			...
			public void valueChanged(ListSelectionEvent e) {
					...
					try {
						if(e.getValueIsAdjusting()==true) {
			            	 String x=userList.getSelectedValue();
			            	 String xString=x.substring(0,x.indexOf("("));
			            	 if(x.equals(xString+"(在线)")) {
			            	
			            	 msg.setTargetId(xString);
							  msg.setType("beg_PRIVATE");
							
						PrivateClientUI client=new PrivateClientUI(clientSocket,msg); //创建客户机界面
						
						  client.setTitle("正在与 "+xString+" 进行私聊"); //设置标题
						  client.setVisible(true); //显示会话窗体  
						  LoginUI.clientUIMap.put(xString, client);
						...
						clientSocket.send(packet);
			            	 ...
			            	 else if(x.equals(xString+"(离线)")) {
			            		 msg.setTargetId(xString);
								 msg.setType("OUT_PRIVATE");
								
							PrivateClientUI client=new PrivateClientUI(clientSocket,msg); //创建客户机界面
							
							  client.setTitle("正在与 "+xString+"发送离线消息"); //设置标题
							  client.setVisible(true); //显示会话窗体  
							  LoginUI.clientUIMap.put(xString, client);
							  data=Translate.ObjectToByte(msg); //消息对象序列化
							    //构建发送
        ...
        JButton btnNewButton = new JButton("表情发送");
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		exeUI=new Expression();
        		exeUI.setVisible(true);
        		
        		
        		
        	}
        });
        jToolBar1.add(btnNewButton);
        
        JButton btnNewButton_1 = new JButton("查看离线消息");
    ...
    //发送文件
  /*修改过*/ /* private void PrivateMessage(javax.swing.event.) {//GEN-FIRST:event_btnFileMousePressed
    ...
    //**************xfxf******************
    private void downloadFileActionPerformed(java.awt.event.ActionEvent evt) {
    	 
    	  System.out.println("download file======发送请求消息到服务器端口端口"+msg.getToPort());
    	  try {
              msg.setType("M_DOWNLOAD_REQ"); //消息类型
              msg.setText(null);
